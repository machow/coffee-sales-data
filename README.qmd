...
This repository generates sales data for a fictitious coffee device store (see this [jupyter notebook](./example_notebook.ipynb)).
It's used to generate this table for the Great Tables examples gallery (scroll down for code):
